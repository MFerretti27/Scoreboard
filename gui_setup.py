...
def gui_setup() -> sg.Window:
    ...
    home_record_layout = [
        [sg.Image("sport_logos/team0_logos/DET.png", key='home_logo', pad=((0, 0),(SPACE_BETWEEN_TOP_AND_LOGOS,0)))],
        [sg.Text("HOME",font=(FONT, RECORD_TXT_SIZE), key='home_record')]
        ]

    away_record_layout = [
        [sg.Image("sport_logos/team0_logos/PIT.png", key='away_logo', pad=((0, 0),(SPACE_BETWEEN_TOP_AND_LOGOS,0)))],
        [sg.Text("AWAY",font=(FONT, RECORD_TXT_SIZE), key='away_record')]
        ]

    score_layout = [
        [sg.Text("24",font=(FONT, SCORE_TXT_SIZE), key='away_score', pad=((0,0),(SPACE_BETWEEN_TOP_AND_SCORE, 0))),
        sg.Text("-",font=(FONT, HYPHEN_SIZE), key='hyphen', pad=((0,0),(SPACE_BETWEEN_TOP_AND_SCORE, 0))),
        sg.Text("24",font=(FONT, SCORE_TXT_SIZE), key='home_score', pad=((0,0),(SPACE_BETWEEN_TOP_AND_SCORE, 0)))],
